...
# 出力ファイル
output_file="execution05_times.log"

# コマンド23a: fullprove
cmd23a="snarkjs groth16 fullprove /home/y.okura/zkp/code/input1.json circuit05_js/circuit05.wasm circuit05_final.zkey proof.json public.json"
