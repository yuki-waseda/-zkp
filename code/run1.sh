...
snarkjs wtns calculate circuit_js/circuit.wasm  /home/y.okura/zkp/code/input1.json witness.wtns && \
...
##23a
snarkjs groth16 fullprove  /home/y.okura/zkp/code/input1.json circuit_js/circuit.wasm circuit_final.zkey proof.json public.json && \
##24
