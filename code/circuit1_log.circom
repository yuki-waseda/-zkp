...
include "/home/y.okura/zkp/circomlib/circuits/bitify.circom";        // ビット変換
include "/home/y.okura/zkp/circomlib/circuits/eddsaposeidon.circom"; // 署名の検証
...
template Main (out_dim, in_dim, S_clip, sigma) {
   ...
   var binom_mean = hash_len * num_iterations / 2; //(254 * num_iterations /2)
